...
# nodes/practice.py). Default used when the upload form doesn't send a
# count (or sends one outside the allowed range) — the user can otherwise
# pick their own value per upload, clamped to [MIN, MAX] in routes.py.
